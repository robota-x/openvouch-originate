...
/// IMPORTANT: Updated to your new ID: Fg6PaFpoGXkYsidMpW2BeZ7FEfcYkg476zPFsLnS
#[test]
fn declare_id_matches_anchor_localnet_entry() {
    let expected =
        Pubkey::from_str("Fg6PaFpoGXkYsidMpW2BeZ7FEfcYkg476zPFsLnS").unwrap();
...
fn error_codes_compile_and_exist() {
    ...
    let _err9 = ErrorCode::Unauthorized;
